...
- Element C calculation (Marriage Value + Hope Value)
- Cost apportionment across participating leaseholders
...
- `POST/GET /api/buildings/{id}/notices` - Notice management
- `GET/PUT/DELETE /api/notices/{id}` - Single notice
- `PUT /api/notices/{id}/transition` - State transitions
